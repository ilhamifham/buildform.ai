...
function Home({ showWelcome, showEmail, welcomeDetails, image, placement }) {
    return (
        <div className={`px-4 pb-4 pt-3 flex flex-col gap-8 justify-center items-center h-full lg:flex-row ${showWelcome ? "hidden" : "" || showEmail ? "hidden" : ""}`}>
